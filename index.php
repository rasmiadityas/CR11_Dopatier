    ...
    <div class="container d-flex flex-wrap p-2">
        ...
        while ($i < count($row2)) {
            if ($row2[$i]['status'] == 'Available') {
                ...
                if ($row2[$i]['age'] > 8) {
                    echo "<p class='card-text'><a href='senior.php' style='color:#566787' title='See senior pets!' data-toggle='tooltip'><i class='material-icons'>&#xf21a;</i> I'm a senior!</p></a> ";
                }
                echo "<h5 class='card-title'>" . $row2[$i]['name'] . "</h5>
