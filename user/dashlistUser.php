...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
        $tbody .= "<tr class='text-center'>
            ...
            <td>" . $row['email'] . "</td>
            <td>
            <a href='detailsUser.php?id=" . $row['id'] . "' class='view' title='View' data-toggle='tooltip'><i class='material-icons'>&#xE417;</i></a>
            <a href='updateUser.php?id=" . $row['id'] . "' class='edit' title='Edit' data-toggle='tooltip'><i class='material-icons'>&#xE254;</i></a>
            <a href='deleteUser.php?id=" . $row['id'] . "' class='delete' title='Delete' data-toggle='tooltip'><i class='material-icons'>&#xE872;</i></a>
            </td>
         </tr>";
    }
} else {
...
<head>
    ...
    <title>Dopatier - Admin: User List</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-2">
                ...
                <a href="#">&#8226 User Management</a><br>
            ...
            <div class="col-8 mt-2">
                <p class='h2'>User Management <a href="createUser.php" class="btn btn-secondary"><i class="material-icons">&#xE147;</i>Add User</a>
